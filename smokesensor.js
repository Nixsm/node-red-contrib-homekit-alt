...
module.exports = function (RED) {
    ...
    function HAPSmokeSensorNode(config) {
        ...
        service.on('characteristic-change', function (info) {
            ...
            console.log("HAPSmokeSensorNode(): msg.payload =", msg.payload)
        ...
        // set defaults
        //
        service.setCharacteristic(Characteristic["StatusActive"], true /*node.statusactive*/)
    ...
    RED.nodes.registerType('homekit-smokesensor', HAPSmokeSensorNode)
}
